Public Class Form9
    ...
    Private Sub Button18_Click(sender As Object, e As EventArgs) Handles Button18.Click
        Dim closeMsg = MessageBox.Show("Do you really want to leave game", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning)
